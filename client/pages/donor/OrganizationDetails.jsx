    ...
    <div className="container mt-5">
      <div className="card mb-3">
        ...
        <div className="card-body">
          ...
          {organization.beneficiaries && organization.beneficiaries.length > 0 &&
            <Link to={`/beneficiaries/${organization.beneficiaries[0].id}/stories`} className="btn-custom btn-custom-secondary ms-2">View Stories</Link>
          }
        </div>
      </div>
    </div>
